...
// List is the public endpoint: GET /api/v1/article-categories.
...
// AdminList is the admin endpoint: GET /api/v1/admin/article-categories.
...
// Create handles POST /api/v1/admin/article-categories.
...
// Update handles PUT /api/v1/admin/article-categories/{id}.
...
// Delete handles DELETE /api/v1/admin/article-categories/{id}.
